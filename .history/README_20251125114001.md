...
Se você estiver enfrentando o erro **405 (Connection Failure)** ao tentar criar sessões, consulte o guia de troubleshooting: [TROUBLESHOOTING_405.md](./TROUBLESHOOTING_405.md)

**Resumo:** O erro 405 geralmente ocorre quando o WhatsApp bloqueia conexões de IPs de data centers. Execute o serviço em ambiente local ou use um proxy residencial.
