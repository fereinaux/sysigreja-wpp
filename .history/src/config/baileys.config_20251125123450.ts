  ...
  socket.ev.on("connection.update", async (update) => {
    ...
    if (qr) {
      ...
      try {
        ...
        console.log(
          `[Baileys] ✅ QR Code convertido para base64 (tamanho: ${qrBase64.length} chars)`
        );
        // Salvar QR Code base64 no Redis e notificar callback
        ...
        // Em caso de erro, salvar a string original
