...
export async function createBaileysSocket(
  ...
  const socket = makeWASocket({
    ...
    // Configuração de browser - tentando usar formato que pode evitar detecção
    // Alternativa: Browsers.macOS('Desktop') - descomente se necessário
    browser: ["SysIgreja", "Chrome", "1.0.0"],
    // browser: Browsers.macOS('Desktop'), // Alternativa mencionada em algumas issues
